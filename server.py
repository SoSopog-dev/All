    ...
    def main():
        ...
        while run:
            ...
            try:
                ...
                #if it is not the write size the client will not send the image. this helps not reciving corrupt images
                ...
                if mouse_activated == True:
                    ...
                    conn.send(("x" + str(x)).encode())
                    time.sleep(0.1)
                    conn.send(("y" + str(y)).encode())
                    time.sleep()
